        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
              All kind of exclusive accessories for Men Women and kids with best deals!
            </p>
            
            <button
              type="button"
              onClick={() => router.push("/product/listing/all-products")}
              className="mt-1.5 inline-block bg-green-500 px-5 py-3 text-xs font-medium uppercase tracking-wide text-black"
            >
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/onlineshop-3b1c4.appspot.com/o/ecommerce%2Fbanner.png-1705094591054-oaqecjrx05?alt=media&token=9ec1a574-a7a7-4928-98ae-7fce1b23ea0a"
              ...
              <div className="relative block group">
                ...
                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
                  ...
                  <button
                    ...
                    className="mt-1.5 inline-block bg-blue-500 px-5 py-3 text-xs font-medium uppercase tracking-wide text-black"
                  >
                    Shop Now
                  </button>
                </div>
